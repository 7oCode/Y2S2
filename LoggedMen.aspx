<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin.Master" AutoEventWireup="true" CodeBehind="LoggedMen.aspx.cs" Inherits="WebAppProject.LoggedMen" EnableEventValidation="false" %>
                            ...
                            <div class="best_shoes">
                                ...
                                <div class="star_text">
                                    ...
                                    <div class="right_part">
                                        ...
                                        <asp:Label ID="lblCategory" Text="Men_Daily" runat="server" Visible="false"></asp:Label>
                        ...
                        <div class="col-sm-4">
                            <div class="best_shoes">
                                ...
                                <div class="star_text">
                                    ...
                                    <div class="right_part">
                                        <asp:Label ID="lblMDailyPrice" CssClass="shoes_price" runat="server" ForeColor="#ff5e5b" Text='<%#Eval("ShoePrice") %>'></asp:Label>
                                        <asp:Label ID="lblCategory" Text="Men_Long" runat="server" Visible="false"></asp:Label>
                        ...
                        <div class="col-sm-4">
                            <div class="best_shoes">
                                ...
                                <div class="star_text">
                                    ...
                                    <div class="right_part">
                                        <asp:Label ID="lblMDailyPrice" CssClass="shoes_price" runat="server" ForeColor="#ff5e5b" Text='<%#Eval("ShoePrice") %>'></asp:Label>
                                        <asp:Label ID="lblCategory" Text="Men_Racing" runat="server" Visible="false"></asp:Label>
