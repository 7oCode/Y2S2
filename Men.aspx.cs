...
{
    public partial class Men : BasePage
    {
        ...
        protected void addCart(object sender, EventArgs e)
        {
            ...
            using(SqlConnection con = new SqlConnection(conn))
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO UserCart (Username, ProductName, ProductPrice, Quantity, TotalPrice) VALUES (@user ,@Name, @Price, @Quantity, @total)", con);
