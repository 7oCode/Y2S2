<%@ Page Title="" Language="C#" MasterPageFile="~/EComms.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="WebAppProject.Search" %>
                    ...
                    <ItemTemplate>
                        <div class="col-sm-4">
                            <div class="best_shoes">
                                ...
                                <asp:Label ID="Label1" CssClass="best_shoes" runat="server" Text='<%#Eval("Gender") %>'></asp:Label>
